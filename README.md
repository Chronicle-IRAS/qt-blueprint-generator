...
- 交互式画布：节点拖动、框选、缩放、端口拖拽连线、分支标签、属性编辑及撤销/重做。
...
编辑器窗口已经支持画布编辑、从输出端口拖拽创建连线、属性修改、语言切换，以及对已准备工作目录的构建和导出。View 菜单可以重新显示 Properties、Build and Export 面板，Reset Layout 可恢复默认停靠区域和可见性。
